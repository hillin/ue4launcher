...
namespace UE4Launcher.Launcher
{
	internal static class Arguments
	{
		...
		public static readonly ArgumentInfo LaunchMode =
			new MappingArgumentInfo<LaunchModeEnum>("LaunchMode", new Dictionary<LaunchModeEnum, string>
			{
		...
		public static readonly ArgumentInfo RHIType =
			new MappingArgumentInfo<RHITypeEnum>("RHIType", new Dictionary<RHITypeEnum, string>
			{
				{RHITypeEnum.DirectX10, "D3D10"},
				{RHITypeEnum.DirectX11, "D3D11"},
				{RHITypeEnum.DirectX12, "D3D12"},
				{RHITypeEnum.OpenGL3, "OPENGL3"},
				{RHITypeEnum.OpenGL4, "OPENGL4"},
				{RHITypeEnum.Vulkan, "VULKAN"}
			}, "Set the graphics API used to render game");

		public static readonly ArgumentInfo RHIFeatureLevel =
			new MappingArgumentInfo<RHIFeatureLevelEnum>("RHIFeatureLevel", new Dictionary<RHIFeatureLevelEnum, string>
			{
				{RHIFeatureLevelEnum.OpenGLES2, "FeatureLevelES2"},
				{RHIFeatureLevelEnum.OpenGLES31, "FeatureLevelES31"},
